...
print("Shape of train_input_dynamic_final:", train_input_dynamic_final.shape)
print("Shape of train_output_final:", train_output_final.shape)
print("Shape of cate_feature_final:", cate_feature_final.shape)
print("Batch size:", BATCH_SIZE)
print("Number of training samples:", train_input_dynamic_final.shape[0])

# above portion will be to preprocess for the DCNN model
